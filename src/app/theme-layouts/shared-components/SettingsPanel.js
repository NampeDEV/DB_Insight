...
import FuseSettings from '@aiscore/core/FuseSettings';
...
import FuseThemeSchemes from '@aiscore/core/FuseThemeSchemes';
...
function SettingsPanel() {
  ...
  return (
    <>
      {/* <Root id="aiscore-settings-schemes" className="buttonWrapper">
        <Button
