      ...
      <Root sx={item.sx}>
        <ListItem
          ...
          className={clsx(
            ...
            'aiscore-list-item flex flex-col items-center justify-center p-12'
          )}
          ...
          {dense ? (
            <Tooltip title={item.title || ''} placement="right">
              <div className="w-32 h-32 min-h-32 flex items-center justify-center relative">
                {item.icon ? (
                  <FuseSvgIcon
                    className={clsx('aiscore-list-item-icon', item.iconClass)}
                    color="action"
                  >
                    {item.icon}
                  </FuseSvgIcon>
            ...
            <>
              ...
              <ListItemText
                className="aiscore-list-item-text grow-0 w-full"
                primary={item.title}
                classes={{
                  primary:
                    'text-12 font-medium aiscore-list-item-text-primary truncate text-center truncate',
                }}
              />
            </>
          )}
