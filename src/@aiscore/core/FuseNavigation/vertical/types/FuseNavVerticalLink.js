    ...
    () => (
      ...
      >
        ...
        <ListItemText
          ...
          classes={{
            primary: 'text-13 font-medium aiscore-list-item-text-primary truncate',
            secondary: 'text-11 font-medium aiscore-list-item-text-secondary leading-normal truncate',
          }}
        />
